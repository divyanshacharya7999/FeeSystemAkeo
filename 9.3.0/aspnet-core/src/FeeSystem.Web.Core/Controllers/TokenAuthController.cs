...
using FeeSystem.Authentication.JwtBearer;
...
namespace FeeSystem.Controllers
{
    ...
    public class TokenAuthController : FeeSystemControllerBase
    {
        ...
        private List<Claim> CreateJwtClaims(ClaimsIdentity identity)
        {
            ...
            claims.AddRange(new[]
            {
                ...
                if (AbpSession.TenantId.HasValue)
    {
        claims.Add(new Claim("tenantId", AbpSession.TenantId.Value.ToString()));
    }

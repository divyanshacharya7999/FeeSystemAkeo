...
{
    [DbContext(typeof(FeeSystemDbContext))]
    [Migration("20240823110600_Adding NormalizePlanName")]
    partial class AddingNormalizePlanName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeeManagementSystem.Classes.Class", b =>
                {
            ...
            modelBuilder.Entity("FeeManagementSystem.FeeTypes.FeeType", b =>
                {
                    ...
                    b.Property<string>("NormalizedFeeTypeName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FeeManagementSystem.Fees.Fee", b =>
                {
            ...
            modelBuilder.Entity("FeeManagementSystem.PaymentPlans.PaymentPlan", b =>
                {
                    b.Property<int>("PaymentPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NormalizedPlanName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FeeManagementSystem.Payments.Payment", b =>
                {
            ...
            modelBuilder.Entity("FeeManagementSystem.StudentFees.StudentFee", b =>
                {
                    ...
                    b.Property<double>("AmountPerPeriod")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("UpdatedTotalAmount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("FeeManagementSystem.Students.Student", b =>
                {
                    b.Property<string>("StudentId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FeeSystem.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FeeSystem.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FeeSystem.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FeeSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FeeSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FeeManagementSystem.Fees.Fee", b =>
                {
                    b.HasOne("FeeManagementSystem.Classes.Class", "Class")
                        .WithMany("Fees")
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FeeManagementSystem.FeeTypes.FeeType", "FeeType")
                        .WithMany("Fees")
                        .HasForeignKey("FeeTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FeeManagementSystem.PaymentPlans.PaymentPlan", "PaymentPlan")
                        .WithMany("Fees")
            ...
            modelBuilder.Entity("FeeManagementSystem.Payments.Payment", b =>
                {
                    b.HasOne("FeeManagementSystem.Fees.Fee", "Fee")
                        .WithMany("Payments")
                        .HasForeignKey("FeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FeeManagementSystem.Students.Student", "Student")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("FeeSystem.Authorization.Roles.Role", b =>
                {
                    b.HasOne("FeeSystem.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("FeeSystem.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("FeeSystem.Authorization.Users.User", "LastModifierUser")
                        .WithMany()

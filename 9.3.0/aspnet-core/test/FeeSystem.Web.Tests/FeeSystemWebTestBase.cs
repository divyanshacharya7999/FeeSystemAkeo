...
using FeeSystem.Web.Startup;
using AngleSharp.Html.Dom;
using AngleSharp.Html.Parser;
using Microsoft.AspNetCore.Hosting;
using Shouldly;

namespace FeeSystem.Web.Tests
{
    public abstract class FeeSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FeeSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FeeSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FeeSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FeeSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FeeSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FeeSystemDbContext, Task<T>> func)
        {
            T result;
